...
export default function Infobox({info}){
    ...
    const rainyImg="https://images.unsplash.com/photo-1519692933481-e162a57d6721?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    return(
        <div className='W_card'>
            <Card sx={{ maxWidth: 345 }}>
                <CardMedia
                    sx={{ height: 140 }}
                    image={info.humidity>80?rainyImg : info.temp>30?hotImg : info.temp<15?coldImg : hazeImg}
                    title="Weather"
                />
                <CardContent>
